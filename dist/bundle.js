...
var countercomment = document.querySelector('.countercomment');
var shows = document.querySelector('.shows');
var nooflikes = 0;
id.forEach(function (movie) {
  (0,_modules_displayShows_js__WEBPACK_IMPORTED_MODULE_1__["default"])(movie).then( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0,_modules_fetchlike_js__WEBPACK_IMPORTED_MODULE_6__["default"])(key);
            case 2:
              likesdisplay = _context.sent;
              nooflikes = 0;
              likesdisplay.forEach(function (element) {
  ...
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0,_modules_itemCounter_js__WEBPACK_IMPORTED_MODULE_7__["default"])();
        case 2:
          itemCounter = _context2.sent;
          shows.innerHTML = "Shows (".concat(itemCounter, ")");
        case 4:
        case "end":
...
movies.addEventListener('click', /*#__PURE__*/function () {
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (e.target.classList.contains('comment-button')) {
              (0,_modules_displayShows_js__WEBPACK_IMPORTED_MODULE_1__["default"])(e.target.parentElement.id).then( /*#__PURE__*/function () {
            ...
            _context4.next = 5;
            return (0,_modules_like_js__WEBPACK_IMPORTED_MODULE_5__["default"])({
              item_id: ID
            }, key);
          case 5:
            _context4.next = 7;
...
popupCommentButton.addEventListener('click', function () {
...
function _fetchData() {
  _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var fetching;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://api.tvmaze.com/shows/".concat(id)).then(function (response) {
              return response.json();
            });
          case 2:
            fetching = _context.sent;
            return _context.abrupt("return", fetching);
          case 4:
          case "end":
            return _context.stop();
        }
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var commentsload = document.querySelector('.commentsload');
function fetchcomment(_x, _x2) {
  return _fetchcomment.apply(this, arguments);
}
function _fetchcomment() {
  _fetchcomment = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, key) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            commentsload.innerHTML = '';
            _context.next = 3;
            return fetch("https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/".concat(key, "/comments?item_id=").concat(id)).then(function (res) {
              return res.json();
            }).then(function (output) {
              if (output.error) {
                return;
              ...
              output.forEach(function (comment) {
                commentsload.innerHTML += "<p><span>".concat(comment.creation_date, " ").concat(comment.username, ": ").concat(comment.comment, "</span></p>");
              });
            });
          case 3:
          case "end":
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
function fetchlike(_x) {
  return _fetchlike.apply(this, arguments);
}
function _fetchlike() {
  _fetchlike = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(key) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", fetch("https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/".concat(key, "/likes")).then(function (res) {
              return res.json();
            }).then(function (output) {
              return output;
            }));
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var itemCounterFunction = function itemCounterFunction() {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var addlike = function addlike(Obj, key) {
  return fetch("https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/".concat(key, "/likes"), {
    method: 'POST',
    headers: {
      'Content-type': 'application/json; charset=UTF-8'
    },
